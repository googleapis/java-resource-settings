  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "to\032\027google/api/client.proto\032\037google/api/field_behavior.proto\032\031google/api/resource.proto\"\267\003\n"
          + "\007Setting\022\014\n"
          + "\004name\030\001 \001(\t\022H\n"
          + "\010metadata\030\007"
          + " \001(\01321.google.cloud.resourcesettings.v1.SettingMetadataB\003\340A\003\022<\n"
          + "\013local_value\030\010 \001(\0132\'.google.cloud.resourcesettings.v1.Value\022E\n"
          + "\017effective_value\030\t"
          + " \001(\0132\'.google.cloud.resourcesettings.v1.ValueB\003\340A\003\022\014\n"
          + "\004etag\030\n"
          + " \001(\t:\300\001\352A\274\001\n"
          + "\'resourcesettings.googleapis.com/Setting\0221projects/{projec"
          + "t_number}/settings/{setting_name}\022(folders/{folder}/settings/{setting_name}\0224organizations/{organization}/settings/{setting_name}\"\276\002\n"
          + "\017SettingMetadata\022\024\n"
          + "\014display_name\030\001 \001(\t\022\023\n"
          + "\013description\030\002 \001(\t\022\021\n"
          + "\tread_only\030\003 \001(\010\022M\n"
          + "\tdata_type\030\004"
          + " \001(\0162:.google.cloud.resourcesettings.v1.SettingMetadata.DataType\022>\n\r"
          + "default_value\030\005 \001(\0132\'.google.cloud.resourcesettings.v1.Value\"^\n"
          + "\010DataType\022\031\n"
          ...
          + "\005Value\022\027\n\r"
          + "boolean_value\030\001 \001(\010H\000\022\026\n"
          + "\014string_value\030\002 \001(\tH\000\022M\n"
          + "\020string_set_value\030\003"
          + " \001(\01321.google.cloud.resourcesettings.v1.Value.StringSetH\000\022G\n\n"
          + "enum_value\030\004"
          + " \001(\01321.google.cloud.resourcesettings.v1.Value.EnumValueH\000\032\033\n"
          + "\tStringSet\022\016\n"
          + "\006values\030\001 \003(\t\032\032\n"
          + "\tEnumValue\022\r\n"
          ...
          + "\004view\030\004 \001(\0162-.google.cloud.resourcesettings.v1.SettingView\"l\n"
          + "\024ListSettingsResponse\022;\n"
          + "\010settings\030\001 \003(\0132).google.cloud.resourcesettings.v1.Setting\022\027\n"
          + "\017next_page_token\030\002 \001(\t\"\217\001\n"
          + "\021GetSettingRequest\022=\n"
          + "\004name\030\001 \001(\tB/\340A\002\372A)\n"
          + "\'resourcesettings.googleapis.com/Setting\022;\n"
          + "\004view\030\002 \001(\0162-.google.cloud.resourcesettings.v1.SettingView\"W\n"
          + "\024UpdateSettingRequest\022?\n"
          + "\007setting\030\001"
          + " \001(\0132).google.cloud.resourcesettings.v1.SettingB\003\340A\002*\203\001\n"
          + "\013SettingView\022\034\n"
          + "\030SETTING_VIEW_UNSPECIFIED\020\000\022\026\n"
          + "\022SETTING_VIEW_BASIC\020\001\022 \n"
          + "\034SETTING_VIEW_EFFECTIVE_VALUE\020\002\022\034\n"
          + "\030SETTING_VIEW_LOCAL_VALUE\020\0032\371\006\n"
          + "\027ResourceSettingsService\022\374\001\n"
          + "\014ListSettings\0225.google.cloud.resourcesettings.v1.Li"
          + "stSettingsRequest\0326.google.cloud.resourc"
          + "esettings.v1.ListSettingsResponse\"}\202\323\344\223\002"
          + "n\022%/v1/{parent=organizations/*}/settingsZ!\022\037/v1/{parent=folders/*}/settingsZ\"\022"
          + " /v1/{parent=projects/*}/settings\332A\006parent\022\351\001\n\n"
          + "GetSetting\0223.google.cloud.resourcesettings.v1.GetSettingRequest\032).google.cl"
          + "oud.resourcesettings.v1.Setting\"{\202\323\344\223\002n\022"
          + "%/v1/{name=organizations/*/settings/*}Z!\022\037/v1/{name=folders/*/settings/*}Z\"\022"
          + " /v1/{name=projects/*/settings/*}\332A\004name\022\235\002\n"
          + "\r"
          ...
          + "=folders/*/settings/*}:\007settingZ32(/v1/{setting.name=projects/*/settings/*}:\007set"
          + "ting\032S\312A\037resourcesettings.googleapis.com\322A.https://www.googleapis.com/auth/cloud-platformB\200\002\n"
          ...
          + " Google.Cloud.ResourceSettings.V1\312\002 Go"
