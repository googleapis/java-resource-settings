...
/**
 * Settings class to configure an instance of {@link ResourceSettingsServiceClient}.
 *
...
public class ResourceSettingsServiceSettings
  ...
  public static final ResourceSettingsServiceSettings create(
      ResourceSettingsServiceStubSettings stub) throws IOException {
    return new ResourceSettingsServiceSettings.Builder(stub.toBuilder()).build();
  }
  ...
  protected ResourceSettingsServiceSettings(Builder settingsBuilder) throws IOException {
    super(settingsBuilder);
  }

  /** Builder for ResourceSettingsServiceSettings. */
  public static class Builder
      extends ClientSettings.Builder<ResourceSettingsServiceSettings, Builder> {
    ...
    protected Builder(ResourceSettingsServiceSettings settings) {
      super(settings.getStubSettings().toBuilder());
    }

    protected Builder(ResourceSettingsServiceStubSettings.Builder stubSettings) {
      super(stubSettings);
    }
    ...
    @Override
    public ResourceSettingsServiceSettings build() throws IOException {
